...
\! echo database ${WAREHOUSE_DATABASE} created

CREATE USER IF NOT EXISTS '${WAREHOUSE_USER}'@'%' IDENTIFIED BY '${WAREHOUSE_PASSWORD}';
GRANT ALL PRIVILEGES ON ${WAREHOUSE_DATABASE}.* TO ${WAREHOUSE_USER};
\! echo user ${WAREHOUSE_USER} created
"
